...
export default function Br30TermsCondition() {
  ...
  const styles = `
 .terms-page{background:#050505;color:#fff;display:flex;justify-content:center;align-items:flex-start;padding:0 20px 40px;margin-top:0;min-height:100vh;font-family:"Poppins",sans-serif;}
