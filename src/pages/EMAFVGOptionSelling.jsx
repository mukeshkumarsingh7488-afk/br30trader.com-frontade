export default function EMAFVGOptionSelling() {
  return (
    <>
      <style>{`
...
.note{margin-top:25px;padding:18px;background:#111827;border-left:4px solid #00ff88;border-radius:8px;color:#d1d5db;}
.pdf-box b,.pdf-box strong{color:#fff;font-weight:800;}
@media(max-width:768px){body{padding:16px 10px;}.pdf-box{padding:22px 16px;border-radius:12px;}.pdf-box h1{font-size:26px;}.pdf-box h2{font-size:21px;}.pdf-box h3{font-size:18px;}.pdf-box p,.pdf-box li{font-size:15px;}.pdf-box ul{padding-left:20px;}.note{padding:15px;font-size:15px;}}
@media(max-width:430px){body{padding:10px 8px;}.pdf-box{padding:18px 14px;}.pdf-box h1{font-size:24px;}.pdf-box h2{font-size:20px;}.pdf-box p,.pdf-box li{font-size:14.5px;}}
      ...
      <div className="pdf-box">
        <h1>✅ 9 EMA + 15 EMA + FVG (Option Selling) Strategy</h1>

        <p>
          This strategy uses a combination of <b>EMA crossover and Fair Value Gap (FVG) for short-term option selling</b>.
        </p>
        ...
        <ul>
          ...
          <li>Objective: Trend-following + high-probability short trades</li>
        </ul>
        ...
        <h3>2️⃣ Entry Rules (Option Selling)</h3>

        <p>
          <b>Bearish Entry (Sell Call / Buy Put):</b>
        </p>
        <ul>
          <li>9 EMA crosses below 15 EMA</li>
          <li>Price retraces back to the FVG resistance zone</li>
          <li>Sell a Call Option near the strike close to the current price</li>
        </ul>

        <p>
          <b>Bullish Entry (Sell Put / Buy Call):</b>
        </p>
        <ul>
          <li>9 EMA crosses above 15 EMA</li>
          <li>Price retraces back to the FVG support zone</li>
          <li>Sell a Put Option near the strike close to the current price</li>
        </ul>

        <h2>✅ Exit Rules</h2>
        <ul>
          <li>Target: Next significant swing high or swing low</li>
          <li>Stop Loss: Beyond the FVG zone for protection</li>
