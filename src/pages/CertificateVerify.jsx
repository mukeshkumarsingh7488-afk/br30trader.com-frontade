    ...
    <>
      ...
      <main className="certificate-page">
        <div className="verify-card">
          <img src="https://i.ibb.co/KxnQc4gx/BR30-LOGO1.png" alt="BR30" width="80" className="verify-logo" />
