...
export default function Br30VipAccess() {
  const styles = `
    ...
    .vip-btn {
      ...
      margin-top: 25px;
      background: linear-gradient(90deg, #ff4d4d, #f91b1b);
      color: white;
      padding: 16px 35px;
      border-radius: 50px;
      ...
      <main className="vip-access-page">
        <div className="vip-container">
          ...
          <section className="vip-card">
            ...
            <p>BR30 VIP Access is designed for serious traders who want structured learning, practical market guidance, and premium trading support in one place.</p>
          </section>
          ...
          <section className="vip-card">
            ...
            <p>VIP members get access to premium community support, structured course updates, market breakdowns, and learning guidance focused on discipline and consistency.</p>
          </section>
