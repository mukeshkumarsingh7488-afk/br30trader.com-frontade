...
export default function Leaderboard() {
  ...
  * {
  ...
  .leaderboard-wrapper {
    ...
    align-items: center;
    background: radial-gradient(circle at center, rgba(0,255,136,0.10), #001108 45%, #020403 100%);
  ...
  .bubbles span {
    ...
    margin: 0 4px;
    border-radius: 50%;
    box-shadow: 0 0 15px #00ff8844, 0 0 30px #00ff8822;
...
.animated-leaderboard-box {
  ...
  animation: leaderboardGlow 2.5s ease-in-out infinite alternate;
  ...
  .Trader-item {
    height: 62px;
    background: linear-gradient(145deg, #050505, #0c0c0c);
  ...
  .Trader-item:hover {
    ...
    border-color: #00ff88;
    background: linear-gradient(145deg, #07120d, #0c0c0c);
    box-shadow: 0 0 18px rgba(0,255,136,0.22), inset 0 0 14px rgba(255,255,255,0.03);
  }
  ...
  .vip-btn:hover {
    ...
    border-color: #00eaff;
    color: #00eaff;
    box-shadow: 0 0 24px rgba(0,234,255,0.75);
  }
