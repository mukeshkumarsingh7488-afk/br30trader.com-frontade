  ...
  return (
    <section id="coursesection" className="course-section">
      ...
      <style>{`
        ...
        .card-tag{position:absolute;top:1px;right:18px;background:#00ff88;color:#000;padding:8px 14px;border-radius:20px;font-size:12px;font-weight:900;z-index:3}
