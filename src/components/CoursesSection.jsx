...
export default function CoursesSection() {
  ...
  return (
    <section id="coursesection" className="course-section">
     ...
     .card-tag{position:absolute;top:-14px;right:18px;background:#00ff88;color:#000;padding:8px 14px;border-radius:20px;font-size:12px;font-weight:900;z-index:5;box-shadow:0 0 15px rgba(0,255,136,.35)}
